...
ActiveRecord::Schema.define(version: 2020_12_30_103915) do
  ...
  create_table "measurement_files", force: :cascade do |t|
    t.bigint "measurement_id"
    t.string "measurement_file"
    t.string "token"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["measurement_id"], name: "index_measurement_files_on_measurement_id"
  end
